...
// Import our contract artifacts and turn them into usable abstractions. // Zhu
...
// MetaCoin is our usable abstraction, which we'll use through the code below.  // Zhu
...
window.App = {
  start: function() {
    ...
    // Bootstrap the MetaCoin abstraction for Use. // Zhu
  ...
  sendCoinToMe: function() {
    ...
    var amount = 234
    var receiver = "0x2e7Ed09d5bf2bDFCc8044e50Dc43E8684d48689e";
    ...
    MetaCoin.deployed().then(function(instance) {
      ...
      //self.setStatus("Transaction complete!");  // Zhu
  ...
  toggleSendFeeButton: function() {
      ...
      sendFeeButton.style.display = "block";
  }
